...
SBIT(PIN_74HC393_FIRE_CLK_O, P2, 2); // Clocks U5A 4-bit counter
SBIT(PIN_74HC393_TEST_CLK_O, P2, 3); // Clocks U5B 4-bit counter
// PIN 2.4 - Open
SBIT(PIN_RFM69HW_RST_O,      P2, 5); // RFM69HW RST
SBIT(PIN_74HC393_CLEAR_O,    P2, 6); // Clears U5A and U5B
// PIN 2.7 - C2D
